...
urlpatterns = [
    ...
    path('order/add-item/<int:order_id>/<int:item_id>', views.add_item, name = "add-item"),
    path('order/remove-item/<int:order_id>/<int:item_id>', views.remove_item, name = "remove-item"),
